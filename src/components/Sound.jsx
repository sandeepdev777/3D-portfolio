...
// when user first visits the page then a modal will appear asking for music consent
...
const Sound = () => {
  ...
  // at first when user interacts with the page then only music will play otherwise not since its state is stored in local storage
